...
public class EgovStringUtil {
	...
	public static String addMinusChar(String date) {
	 ...
	 /**
	 * 0~9 까지 램덤한 숫자를 반환(length 문자열길이)
	 * @param length
	 * @return
	 */
	public static String generateRandomString(int length) {
        ...
        for (int i = 0; i < length; i++) {
            int rndCharAt = random.nextInt(10);
            sb.append(rndCharAt);
        }
        return sb.toString();
    }
	...
	/**
	 * 왼쪽에 주어진 기이만큼 특정 문자로 채운다
	 * @param strContext
	 * @param strChr
	 * @param len
	 * @return
	 */
	public static String setLpad(String strContext, String strChr, int len) {
		String strResult = "";
		
		StringBuilder sbAddChar = new StringBuilder();
		int i = 0;
		for(i = strContext.length(); i < len; i++) {
			sbAddChar.append(strChr);
		}
		sbAddChar.append(strContext);
		strResult = sbAddChar.toString();
		return strResult;
	}
	
	/**
	 * 오른쪽에 주어진 기이만큼 특정 문자로 채운다
	 * @param strContext
	 * @param strChr
	 * @param len
	 * @return
	 */
	public static String setRpad(String strContext, String strChr, int len) {
		String strResult = "";
